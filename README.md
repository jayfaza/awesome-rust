...
* [smithay](https://github.com/Smithay/smithay) - [smithay](https://crates.io/crates/smithay) is a safe and well-documented library directed to provide building blocks to create Wayland compositors
